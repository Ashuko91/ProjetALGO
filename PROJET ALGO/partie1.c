...
// Version 1 RECURSIVE SIMPLE AVEC N NEGATIFS
...
{   
    ...
    // Test Question 1
    // printf("UnSurFactorielle : %lf\n", UnSurFactorielle(9)); // Je m'arretes a n = 9 car au-dela le resultat est le meme
   ...
   // Test des Fonctions power avec des puissance de 10
    //int N = 4;
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_1(4)); // A partir de 10^5, la fonction stope et ne renvoie rien
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_2(4));
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_3(4)); // A partir de 10^5, la fonction stope et ne renvoie rien
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_4(4)); // A partir de 10^5, la fonction stope et ne renvoie rien
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_5(4)); // A partir de 10^10, la fonction rame et renvoie un resultat bizarre
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_6(4)); // A partir de 10^10, la fonction rame et renvoie un resultat bizarre
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_7(4)); // A partir de 10^10, la fonction rame et renvoie un resultat bizarre
    //printf("Puissance de 10 : n = %d, resultat = %lf\n", 4, PuissancesDe10_8(4)); // A partir de 10^10, la fonction rame et renvoie un resultat bizarre
   ...
   //printf("X3 pour n = %d, terme = %lf\n", 5, X3(35)); // A partir de X(35), la fonction rame 
